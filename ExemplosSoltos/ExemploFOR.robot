...
*** Keywords ***
#Exemplo de chamada Então adiciono 5 novos usuários
Então adiciono ${Quantidade} novos usuários
    FOR  ${i}  IN RANGE  ${Quantidade}
        Wait Until Element Is Visible  ${new_employee.Input_FirstName}
        Input Text  ${new_employee.Input_FirstName}  ${employee.First_Name} ${i} #Apenas um espaço diz que essa 2 variavel faz parte da primeira variavel
